...
export const ROUTE_PERMISSIONS = {
  [ROUTES.DASHBOARD]: ['superadmin', 'platform_admin', 'org_admin', 'org_sub_admin'],
  [ROUTES.PLATFORM_ADMINS]: ['superadmin'],
  [ROUTES.SUBSCRIPTION_PLANS]: ['superadmin', 'platform_admin'],
  [ROUTES.ORGANIZATIONS]: ['superadmin', 'platform_admin'],
  [ROUTES.NFC_REQUESTS]: ['superadmin', 'platform_admin'],
  [ROUTES.OPERATIONS_NFC_REQUESTS]: ['superadmin', 'platform_admin'],
  [ROUTES.OPERATIONS_NFC_REQUEST_DETAIL]: ['superadmin', 'platform_admin'],
  [ROUTES.BROADCASTS]: ['superadmin', 'platform_admin'],
  [ROUTES.ACTIVITY_LOGS]: ['superadmin', 'platform_admin'],
  [ROUTES.SUPPORT_TICKETS]: ['superadmin', 'platform_admin', 'org_admin', 'org_sub_admin'],
  [ROUTES.B2C_USERS]: ['superadmin', 'platform_admin'],
  [ROUTES.FNF_ONBOARDING]: ['superadmin'],
  [ROUTES.FNF_USER_DETAIL]: ['superadmin'],
  [ROUTES.FNF_USER_EDIT]: ['superadmin'],
  [ROUTES.FNF_BULK_IMPORT]: ['superadmin'],
  ...
  [ROUTES.PROFILE]: ['superadmin', 'platform_admin', 'org_admin', 'org_sub_admin'],
  [ROUTES.SETTINGS]: ['superadmin', 'platform_admin', 'org_admin'],
...
export const NAVIGATION_ITEMS: NavigationItem[] = [
  {
    ...
    icon: 'Home',
    roles: ['superadmin', 'platform_admin', 'org_admin', 'org_sub_admin'],
  },
